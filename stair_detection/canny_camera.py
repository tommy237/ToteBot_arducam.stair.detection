...
detectedTxt="Hey! stairs omg"
detectedClr=(0,255,120)
quitKeyCode='q'
...
def cameraMod():
    ...
    # ___________ CAMERAVIEW2 INITIALIZATION ___________ #
    ...
    while True:
        ...
        #|______________| C A N N Y   E D G E S |______________|#
        ...
        #_______________________________________________________#
        #|______________| H O U G H   L I N E S |______________|#
            ...
            for line in houghLines:
                ...
                if (angle<5 or abs(angle-180)<5):
                    ...
                    cv2.line(img=cannyEdges,pt1=(x1,y1),pt2=(x2,y2),
                             color=detectedClr,thickness=2)
        if (horizCount>=2): #// We have detected potential stairs!
            cv2.putText(img=cannyEdges,text=detectedTxt,
                        org=(50,50),fontFace=cv2.FONT_HERSHEY_SIMPLEX,
                        fontScale=1,color=detectedClr,thickness=1)
        ...
        if (cv2.waitKey(delay=1) and 0xFF==ord(quitKeyCode)):
            break
    camera.release()
